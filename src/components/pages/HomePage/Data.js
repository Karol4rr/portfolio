...
export const homeObjThree = {
  ...
  lightText: false,
  lightTextDesc: false,
  topLine: 'karol.mika4@gmail.com',
  headline: 'Hello there!',
  description: `Feel free to contact me in any Business Inquiries related to Web Development in technologies such as: HTML5, CSS3, Bootstrap 4, JavaScript, jQuery, R, Python, Django, React and React Native. I'd be happy to cooperate 😄`,
  imgStart: 'start',
